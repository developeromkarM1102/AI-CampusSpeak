    ...
    <motion.div initial="hidden"
      ...
      <div className='flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-20 w-full max-w-7xl mt-7'>
        <div className='flex flex-col justify-center w-full max-w-md'>
          ...
          >
            <motion.div className='text-center bg-blue-400 px-8 py-4 rounded-2xl w-full mb-5'>
            ...
            <p className='text-black text-sm md:text-base text-center mb-6'>
              ...
              <span className='inline-block ml-3 bg-blue-500 px-4 py-2 rounded-2xl'>
                <a href="/user/register" className='cursor-pointer text-white hover:text-gray-200'>
        ...
        <motion.img variants={fadeUp}
          src="/Login.webp"
          className="w-full h-120 mt-13 max-w-md lg:max-w-xl rounded-2xl object-cover hidden md:block"
          alt="login"
        />
      </div>
    </motion.div>
